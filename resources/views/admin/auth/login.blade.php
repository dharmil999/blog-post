                    ...
                    <div class="auth-inner py-2">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" id="login_form" name="login_form"
                                    action="{{ route('admin.login.login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="email" id="email"
                                            placeholder="Enter Email" aria-describedby="email" tabindex="1"
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge" name="password"
                                                id="password" tabindex="2" placeholder="Enter Password"
                                    ...
                                    <a href="{{ route('admin.register.show') }}" class="mb-5">Admin Register</a>
                                    <a href="{{ route('blogger.register.show') }}">Blogger Register</a>
